        ...
        <div className="w-full">
            ...
            <section className="min-h-screen flex flex-col items-center justify-center px-4 md:px-12 lg:p-24">
                ...
                <section className="text-center space-y-4">
                    <p>
                        M.A.P. is a math advancement platform that allows student to practice an infinite number of
                        mathematical problems! By using both context-free grammar and greedy algorithms, we can generate
                        any type of problem. We also use an adaptive difficulty adjustment, adjusting the difficulty
                        base on user interactions. Come join and starting practicing today!
                    </p>
                </section>
            </section>
            ...
            <section className="min-h-screen flex flex-col items-center justify-center px-4 md:px-12 lg:p-24">
                ...
                <section className="text-center space-y-4">
                    <p>
                        This project was for the CS500 class at Western Kentucky University, directed by Dr. Zhonghang Xia.
                        Some code and designs were implemented using Oracle's ChatGPT and Google's Gemini. All code has
                        been labeled if they were generated by the models.
